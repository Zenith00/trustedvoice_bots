...
CONFIG["CHANNEL_BLACKLIST_IDS"] = [
    CONFIG["CHANNEL_TO_ID"][name] for name in CONFIG["CHANNEL_BLACKLIST_NAMES"]
]
CONFIG["ciID_TO_ROLE"] = {}
CONFIG["ciROLE_TO_ID"] = {}
CONFIG["ID_TO_ROLE"] = {}
...
CONFIG["GUILD_ID"] = 534907871339741194
CONFIG["ACK_TYPE"] = "react"
CONFIG["PREFIX"] = "!"
CONFIG["BOT_TOKEN"] = "TOKEN_HERE"
CONFIG["IMAGE_TARGET_CHANNEL"] = CONFIG["CHANNEL_TO_ID"]["channelname"],
